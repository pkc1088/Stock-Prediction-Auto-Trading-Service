...
- **시연 영상**: [멀티모달 데이터마이닝 기반 주가 예측](https://www.youtube.com/shorts/7GqrPiGFHaA)
- **개발 기간**: 2025-01-03 ~ 2025-07-10 <br><br>
...
- 프로세스:
 1. 종목 의뢰 → 50일치 데이터 확보
 2. LSTM/CNN 예측 → MLP 입력 → 최종 종가 예측
 3. 뉴스 크롤링 → LLM 감정 분석
 4. 결과(예측가, 감정분석, 판단 근거) 반환
 5. 자동매매 승인 시 한국투자 API 연동, 멀티쓰레딩 자동매매 실행
